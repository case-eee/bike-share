...
describe "Station" do
  ...
  describe ".total_stations" do
    it "returns the total number of stations" do
      ...
      Station.create(name:"dave",dock_count:28,city_id:3,installation_date:'1999-10-24')
  ...
  describe ".average_bikes_per_station" do
    it "returns the average number of bikes per station" do
      ...
      Station.create(name:"dave",dock_count:30,city_id:3,installation_date:'1999-10-24')
  ...
  describe ".station_with_max_bikes" do
    it "returns the station with the most bikes" do
      ...
      dave = Station.create(name:"dave",dock_count:30,city_id:3,installation_date:'1999-10-24')
  ...
  describe ".station_with_min_bikes" do
    it "returns the station with the most bikes" do
      eric = Station.create(name:"eric",dock_count:20,city_id:2,installation_date:'1999-10-23')
      dave = Station.create(name:"dave",dock_count:20,city_id:3,installation_date:'1999-10-24')
      nick = Station.create(name:"nick",dock_count:30,city_id:4,installation_date:'1999-10-24')
  ...
  describe ".newest" do
    it "returns the most recently installed station" do
      ...
      dave = Station.create(name:"dave",dock_count:20,city_id:3,installation_date:'2016-5-24')
  ...
  describe ".oldest" do
    it "returns the most recently installed station" do
      eric = Station.create(name:"eric",dock_count:20,city_id:2,installation_date:'1990-5-23')
      dave = Station.create(name:"dave",dock_count:20,city_id:3,installation_date:'1990-5-23')
      nick = Station.create(name:"nick",dock_count:30,city_id:4,installation_date:'2016-5-24')
  ...
  describe '.station_location' do 
    it 'returns hash with lat and lon for each station' do 
      eric = Station.create(name:"eric", dock_count:20, city_id:2, installation_date:'1990-5-23', lat: -31.563910, long: 147.154312)
